...
public class Principal {
    ...
    private final String API_KEY = "&apikey=fb2f81f4";
        ...
        if(serie.isPresent()){
            ...
            List<Episodio> episodios = temporadas.stream()
                    .flatMap(d -> d.episodios().stream()
                            .map(e -> new Episodio(d.numero(), e)))//convierte esos datos episodio en un nuevo episodio
                    .collect(Collectors.toList());// y los colecta en una lista
...
//
//       DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy");//formato en el que se va a mostrar
//       episodios.stream()
